...
# Page Configuration
st.set_page_config(
    page_title="EcoPulse | Renewable Energy Smart Hub",
    page_icon="⚡",
    layout="wide",
...
# --- MODULE 1: DASHBOARD ---
if page == "🏠 Dashboard":
    st.title("🌱 Renewable Energy Smart Calculator Hub")
...
# Footer
st.sidebar.markdown("---")
st.sidebar.write("© 2026 EcoPulse | Innovation for a Greener Planet")
